...
- Результаты выполненных действий (особенно те, что привели к ответам в чате)
- Контекст, необходимый для продолжения
- Статус завершенных задач (только те, что подтверждены ответами в чате)

Ответь кратким резюме на том же языке, что и диалог. Сосредоточься на том, что уже было сказано в чате как на подтверждении выполненных задач.
...
class ContextReducer:
    ...
    RESERVED_TOKENS = 2000  # Increased for better compression
